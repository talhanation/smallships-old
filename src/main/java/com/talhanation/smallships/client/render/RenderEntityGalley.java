...
public class RenderEntityGalley extends EntityRenderer<GalleyEntity>{
    ...
    public RenderEntityGalley(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn);
        this.shadowRadius = 1.6F;
    }

    @Override
    public void render(GalleyEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
