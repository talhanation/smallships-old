...
public class RenderEntityDhow extends EntityRenderer<DhowEntity>{
    ...
    public RenderEntityDhow(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
        this.shadowRadius = 2.0F;
    }

    @Override
    public void render(DhowEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
