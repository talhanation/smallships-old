...
public class RenderEntityDhow extends EntityRenderer<DhowEntity>{
    ...
    public RenderEntityDhow(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn);
        this.shadowRadius = 2.0F;
    }

    @Override
    public void render(DhowEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    public ResourceLocation getTextureLocation(DhowEntity entity) {
        return DHOW_TEXTURES[entity.getBoatType().ordinal()];
    }
