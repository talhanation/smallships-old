...
public class RenderEntityDrakkar extends EntityRenderer<DrakkarEntity>{
    ...
    public RenderEntityDrakkar(EntityRendererProvider.Context renderManagerIn) {
    ...
    @Override
    public void render(DrakkarEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
