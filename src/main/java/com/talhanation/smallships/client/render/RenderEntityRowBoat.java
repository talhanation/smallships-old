...
public class RenderEntityRowBoat extends EntityRenderer<RowBoatEntity>{
    ...
    public RenderEntityRowBoat(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn);
        this.shadowRadius = 1.2F;
    }

    @Override
    public void render(RowBoatEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
