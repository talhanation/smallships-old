...
public abstract class AbstractBriggEntity extends AbstractBannerUser {
    ...
    public AbstractBriggEntity(EntityType<? extends AbstractBriggEntity> entityType, Level worldIn) {
    ...
    protected void controlBoat() {
        ...
        if (this.isVehicle()) {
            ...
            this.setDeltaMovement(this.getDeltaMovement().add((double) (Mth.sin(-getYRot() * ((float) Math.PI / 180F)) * f), 0.0D, (double) (Mth.cos(this.getYRot() * ((float) Math.PI / 180F)) * f)));
